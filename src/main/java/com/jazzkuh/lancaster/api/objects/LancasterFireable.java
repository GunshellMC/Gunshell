...
import com.jazzkuh.lancaster.api.interfaces.LancasterWeaponImpl;
...
public class LancasterFireable implements LancasterWeaponImpl {
    ...
    public LancasterFireable(@NotNull String key, @NotNull ConfigurationSection configuration) {
        this.key = key;
    ...
    public ItemBuilder getItem() {
        ...
        for (String loreString : lore) {
            loreString = PlaceHolder.parse(loreString,
        ...
        ItemBuilder itemBuilder = new ItemBuilder(material)
                .setName(name)
                .setLore(parsedLore)
                .setNBT("lancaster_weapon_key", key)
                .setNBT("lancaster_weapon_ammo", this.getMaxAmmo())
                .setNBT("lancaster_weapon_condition", 100)
                .setNBT("lancaster_weapon_ammotype", this.getAmmunitionKeys().get(0))
